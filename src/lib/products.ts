...
export const products: Product[] = [
  ...
  { sku: "303", name: "Gegenstandslektionen 2", price: 15, description: "54 Gegenstandslektionen zu: Evangelisation, Wunder, Gehorsam, Gebet, Suende, Josef. King's Kids.", image: "/images/products/303-gegenstandslektionen-2.jpg", category: "kids", inStock: true, stock: 10 },
